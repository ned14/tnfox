...
FXVec4d vecnormalize(const FXVec4d& v){
...
FXdouble FXVec4d::vecdistance(const FXVec3d& p) const {
  return x*p.x+y*p.y+z*p.z+w;
  }


// Return true if edge a-b crosses plane
bool FXVec4d::veccrosses(const FXVec3d& a,const FXVec3d& b) const {
  return (vecdistance(a)>=0.0) ^ (vecdistance(b)>=0.0);
  }
