...
QHostAddress QHostAddress::operator&(const QHostAddress &o) const
{
	if(!p->isIPv6 && !o.p->isIPv6) return (p->IPv4 & o.p->IPv4);
	// Compare the IPv6 as IPv4 sets the IPv6
	QHostAddress ret(p->IPv6);
	for(int n=0; n<16; n++)
		ret.p->IPv6[n]&=o.p->IPv6[n];
	return ret;
}
...
Maths::Vector<FXuchar, 16> QHostAddress::ip6Addr() const
{
	return Maths::Vector<FXuchar, 16>(p->IPv6);
}
