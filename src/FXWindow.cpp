...
*********************************************************************************
* $Id: FXWindow.cpp,v 1.339 2006/01/22 17:58:51 fox Exp $                       *
********************************************************************************/
#include "xincs.h"
#include "fxver.h"
#include "fxdefs.h"
...
long FXWindow::onDestroy(FXObject*,FXSelector,void*){
  ...
  if(getEventLoop()->activeWindow==this) getEventLoop()->activeWindow=NULL;
  flags&=~FLAG_FOCUSED;
  xid=0;
  return 1;
  }
...
FXWindow::~FXWindow(){
  ...
  if(getEventLoop()->refresherstop==this) getEventLoop()->refresherstop=parent;
