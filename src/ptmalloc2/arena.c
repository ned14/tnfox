...
static __malloc_ptr_t (*save_malloc_hook) __MALLOC_PMT ((size_t __size,
						       __const __malloc_ptr_t));
# if !defined _LIBC || !defined USE_TLS || (defined SHARED && !USE___THREAD)
static __malloc_ptr_t (*save_memalign_hook) __MALLOC_PMT ((size_t __align,
							 size_t __size,
						       __const __malloc_ptr_t));
# endif
static void           (*save_free_hook) __MALLOC_PMT ((__malloc_ptr_t __ptr,
						     __const __malloc_ptr_t));
