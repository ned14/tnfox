...
/* $Id: hooks.c,v 1.12 2003/09/12 22:28:01 drepper Exp $ */
...
static Void_t*
#if __STD_C
__MALLOC_PMT (malloc_hook_ini(size_t sz, const __malloc_ptr_t caller))
#else
...
static Void_t*
#if __STD_C
__MALLOC_PMT (realloc_hook_ini(Void_t* ptr, size_t sz, const __malloc_ptr_t caller))
#else
...
static Void_t*
#if __STD_C
__MALLOC_PMT (memalign_hook_ini(size_t alignment, size_t sz, const __malloc_ptr_t caller))
#else
...
void
__MALLOC_P (__malloc_check_init())
{
...
#define MAGICBYTE(p) ( (char) ( ((size_t)p >> 3) ^ ((size_t)p >> 11)) & 0xFF )
