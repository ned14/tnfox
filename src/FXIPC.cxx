...
struct FXDLLLOCAL FXIPCChannelPrivate
{
	...
	struct AckEntry
	{
		FXIPCMsg *restrict msg, *restrict ack;
		QWaitCondition *wc;
		FXuint timesent;
		FXException *erroroccurred;
		AckEntry(FXIPCMsg *restrict _msg, FXIPCMsg *restrict _ack, QWaitCondition *_wc)
...
bool FXIPCChannel::getMsgAck(FXIPCMsg *restrict msgack, FXIPCMsg *restrict msg, FXuint waitfor)
{
	QMtxHold h(this);
