...
/* Added by ned 28th July 2005 */
#ifdef __cplusplus
extern "C" {
#endif
	void *tnfxmalloc(size_t size);
	void *tnfxcalloc(size_t no, size_t size);
	void *tnfxrealloc(void *p, size_t size);
	void tnfxfree(void *p);
#ifdef __cplusplus
}
#endif
#define malloc(s) tnfxmalloc(s)
#define calloc(no, s) tnfxcalloc(no, s)
#define realloc(p, s) tnfxrealloc(p, s)
#define free(p) tnfxfree(p)
