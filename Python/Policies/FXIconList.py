...
def applyFXIconList(g, cclass):
    ...
    set_policy(cclass.getHeader,           return_internal_reference())
    set_policy(cclass.getHeaderIcon,       return_internal_reference())
    set_policy(cclass.getItem,             return_internal_reference())
    set_policy(cclass.getItemBigIcon,      return_internal_reference())
