...
def applyQThread(g, cclass):
    ...
    set_policy(cclass.creator,          return_value_policy(reference_existing_object))
    set_policy(cclass.primaryThread,    return_value_policy(reference_existing_object))
    set_policy(cclass.result,           return_internal_reference())
    exclude(cclass.addCleanupCall)
