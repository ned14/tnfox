...
public:
		...
		maxPoints(20000), addPoints(0)
	{
		...
		graphviewer1 = new FXGLViewer(canvasFrame1, PtrPtr(vis1), (FXObject *) 0, 0, LAYOUT_FILL_X | LAYOUT_FILL_Y | VIEWER_FOG | VIEWER_SMOOTH);
		...
		graphviewer2 = new FXGLViewer(canvasFrame2, PtrPtr(vis2), (FXObject *) 0, 0, LAYOUT_FILL_X | LAYOUT_FILL_Y | VIEWER_SMOOTH);
		...
		graphviewer3 = new FXGLViewer(canvasFrame3, PtrPtr(vis3), (FXObject *) 0, 0, LAYOUT_FILL | VIEWER_SMOOTH | VIEWER_LEFTZOOMS);
