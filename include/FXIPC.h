...
public:
	...
	*/
	...
	bool sendMsgI(FXIPCMsg *restrict msgack, FXIPCMsg *restrict msg, endianiseSpec endianise, FXuint waitfor);
	...
	*/
	template<class msgacktype, class msgtype> bool sendMsg(msgacktype *restrict msgack, msgtype *restrict msg, FXuint waitfor=FXINFINITE)
	{
	...
	*/
	bool getMsgAck(FXIPCMsg *restrict msgack, FXIPCMsg *restrict msg, FXuint waitfor=FXINFINITE);
	//! \overload
	bool getMsgAck(FXIPCMsg &restrict msgack, FXIPCMsg &restrict msg, FXuint waitfor=FXINFINITE)
	{
...
class FXIPCChannelIndirector
{
	...
	bool (FXIPCChannel::*sendMsgI)(FXIPCMsg *restrict msgack, FXIPCMsg *restrict msg, FXIPCChannel::endianiseSpec endianise, FXuint waitfor);
	bool (FXIPCChannel::*getMsgAckI)(FXIPCMsg *restrict msgack, FXIPCMsg *restrict msg, FXuint waitfor);
