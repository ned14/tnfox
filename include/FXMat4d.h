...
*********************************************************************************
* $Id: FXMat4d.h,v 1.4.2.1 2006/03/21 07:08:28 fox Exp $                            *
********************************************************************************/
#ifndef FXMAT4D_H
#define FXMAT4D_H
...
public:
  ...
  /// Other operators
  friend FXAPI FXMat4d operator+(const FXMat4d& a,const FXMat4d& b);
  friend FXAPI FXMat4d operator-(const FXMat4d& a,const FXMat4d& b);
  friend FXAPI FXMat4d operator-(const FXMat4d& a);
  friend FXAPI FXMat4d operator*(const FXMat4d& a,const FXMat4d& b);
  ...
  friend FXAPI FXVec4d operator*(const FXVec4d& v,const FXMat4d& m);
  friend FXAPI FXVec4d operator*(const FXMat4d& a,const FXVec4d& v);

  /// Mutiply matrix and vector, for non-projective matrix
  friend FXAPI FXVec3d operator*(const FXVec3d& v,const FXMat4d& m);
  friend FXAPI FXVec3d operator*(const FXMat4d& a,const FXVec3d& v);
  ...
  /// Determinant
  friend FXAPI FXdouble det(const FXMat4d& m);

  /// Transpose
  friend FXAPI FXMat4d transpose(const FXMat4d& m);

  /// Invert
  friend FXAPI FXMat4d invert(const FXMat4d& m);
...
extern FXAPI FXMat4d operator-(const FXMat4d& a,const FXMat4d& b);
extern FXAPI FXMat4d operator-(const FXMat4d& a);
extern FXAPI FXMat4d operator*(const FXMat4d& a,const FXMat4d& b);
...
extern FXAPI FXVec4d operator*(const FXMat4d& a,const FXVec4d& v);

extern FXAPI FXVec3d operator*(const FXVec3d& v,const FXMat4d& m);
extern FXAPI FXVec3d operator*(const FXMat4d& a,const FXVec3d& v);

extern FXAPI FXdouble det(const FXMat4d& m);
extern FXAPI FXMat4d transpose(const FXMat4d& m);
extern FXAPI FXMat4d invert(const FXMat4d& m);
