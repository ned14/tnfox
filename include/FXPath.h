...
namespace FXPath {
	...
	inline FXString join(const FXString &a, const FXString &b)
	{
		FXString ret(a);
	...
	//! \overload
	inline FXString join(const FXString &a, const FXString &b, const FXString &c) { return join(join(a,b), c); }
	//! \overload
	inline FXString join(const FXString &a, const FXString &b, const FXString &c, const FXString &d) { return join(join(join(a,b), c), d); }
