...
public:
  ...
  friend inline FXVec2f veclo(const FXVec2f& a,const FXVec2f& b);
  friend inline FXVec2f vechi(const FXVec2f& a,const FXVec2f& b);

  /// Normalize vector
  friend FXAPI FXVec2f vecnormalize(const FXVec2f& v);
...
extern FXAPI FXVec2f vecnormalize(const FXVec2f& v);
